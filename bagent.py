...
from bmodel import ActorCritic
...
class Agent(object):
    ...
    def step(self, rollout, num_agents):
        ...
        #print ("Advantages :", advantage.size(0), " * ", advantage.size(1) )        
    ...
    def learn(self, states, actions, log_probs_old, returns, advantages, num_agents):
        ...
        for _ in range(NUM_EPOCHS):
            for _ in range(states.size(0) // BATCH_SIZE):
                ...
                #print ("Sampled States :", state_samples.size(0), " * ", state_samples.size(1) )
                #print ("Action Samples :", action_samples.size(0), " * ", action_samples.size(1) )
                #print ("Log prob Samples :", log_prob_samples.size(0), " * ", log_prob_samples.size(1) )
                #print ("Return Samples :", return_samples.size(0), " * ", return_samples.size(1) )
                #print ("Advantage Samples :", advantage_samples.size(0), " * ", advantage_samples.size(1) )
